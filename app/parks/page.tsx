...
// const rows = [
//   createData(true, 'Acadia National Park', 'OR, WA', false),
//   createData(true, 'Acadia National Park', 'OR, WA', false),
//   createData(true, 'Acadia National Park', 'OR, WA', false),
//   createData(true, 'Acadia National Park', 'OR, WA', false),
//   createData(true, 'Acadia National Park', 'OR, WA', false),
...
const rows = [
  createData('Acadia National Park', 'OR, WA', 'visited', false),
  createData('Acadia National Park', 'OR, WA', 'visited', true),
  createData('Erika', 'OR, WA', 'visited', true),
  createData('Julia', 'ME', 'visited', true),
  createData('Sarah', 'CA', 'visited', true),
  createData('Kristin', 'AZ, CO', 'not visited', false),
  createData('Acadia National Park', 'OR, WA', 'visited', true),
  createData('Acadia National Park', 'OR, WA', 'visited', false),
  createData('Acadia National Park', 'OR, WA', 'visited', true),
  createData('Erika', 'OR, WA', 'visited', true),
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.favorited}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
